...
ros::Publisher joint_state_pub("/delta_gripper/joint_state", &joint_state_msg);
...
ros::Subscriber<std_msgs::Bool> stop_sub("/delta_gripper/stop", &stopCallback);
...
ros::Publisher done_moving_deltas_pub("/delta_gripper/done_moving_deltas", &done_moving_deltas_msg);
...
ros::Subscriber<delta_msgs::Float32Array> delta_position_trajectory_sub("/delta_gripper/joint_position_trajectory", &deltaPositionTrajectoryCallback);
...
ros::Subscriber<delta_msgs::Float32Array> delta_velocity_trajectory_sub("/delta_gripper/joint_velocity_trajectory", &deltaVelocityTrajectoryCallback);
...
ros::Subscriber<std_msgs::Empty> reset_sub("/delta_gripper/reset", &resetCallback);
